...
{
    public class JsonComponentVisitor : IComponentVisitor
    {
        private readonly EntityCatalog _entityCatalog;
        private readonly EntityWorld _entityWorld;

        private readonly VisitorMode _mode;

        public JToken SaveData { get; private set; }

        public JsonComponentVisitor() => _mode = VisitorMode.Save;

        public JsonComponentVisitor(
            JToken saveData,
