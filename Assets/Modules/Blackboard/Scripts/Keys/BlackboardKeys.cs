...
namespace Modules.AI
{
    ...
    /// </summary>
    internal static class BlackboardKeys
    {
        private static readonly Dictionary<string, int> _nameToId = new();
        private static readonly Dictionary<int, string> _idToName = new();

        private static IBlackboardNameAlgorithm _algorithm = new SequentialBlackboardNameAlgorithm();
        ...
        public static void SetAlgorithm(IBlackboardNameAlgorithm algorithm)
        {
