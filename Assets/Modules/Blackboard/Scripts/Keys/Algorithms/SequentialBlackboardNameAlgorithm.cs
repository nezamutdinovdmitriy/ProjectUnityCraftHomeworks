...
namespace Modules.AI
{
    ...
    /// </para>
    /// </remarks>
    public sealed class SequentialBlackboardNameAlgorithm : IBlackboardNameAlgorithm
    {
        ...
        /// </param>
        public SequentialBlackboardNameAlgorithm(int nextId = INITIAL_ID) => _nextId = nextId;
